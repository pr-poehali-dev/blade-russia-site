...
const STATS = [
  { value: "2009", label: "Год выхода" },
  { value: "100M+", label: "Игроков в мире" },
  { value: "12", label: "Классов персонажей" },
...
const FEATURES = [
  {
    ...
    desc: "Уникальная система рукопашного боя Blade & Soul основана на реальном кунг-фу. Каждый удар имеет значение — комбо, уклонения и мастерство решают исход битвы.",
  },
  {
    icon: "Users",
    title: "Классы и расы",
    desc: "Выбирай из 12 классов — от стремительного Убийцы до могущественного Чернокнижника. Четыре расы с уникальными историями и особенностями.",
  },
  {
    icon: "Globe",
    title: "Открытый мир",
    desc: "Огромный мир, вдохновлённый азиатской мифологией. Исследуй от заснеженных вершин до раскалённых пустынь, разгадывай тайны древних цивилизаций.",
  },
  {
    icon: "Trophy",
    title: "PvP Арены",
    desc: "Испытай себя в 1v1, 3v3 и масштабных боях между гильдиями. Рейтинговые сезоны с уникальными наградами для лучших бойцов.",
  },
  {
    icon: "Sparkles",
    title: "Графика нового уровня",
    desc: "Визуальный стиль Hyung-tae Kim — рисованный аниме-арт в реальном времени. Поддержка разрешений до 4K и высокая частота кадров.",
  },
  {
    icon: "MessageCircle",
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
              Blade & Soul — корейская MMORPG от NCSoft, объединяющая боевые искусства, азиатскую мифологию и соревновательный геймплей мирового уровня
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16 items-center">
            ...
            <div className="flex flex-col gap-5">
              {[
                {
                  icon: "Zap",
                  title: "Динамичный экшн",
                  desc: "Боевая система на основе реального кунг-фу — уклонения, контратаки, воздушные комбо. Каждый бой уникален.",
                  cyan: false,
                },
                {
                  icon: "Eye",
